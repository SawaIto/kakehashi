...
<body class="bg-blue-100 min-h-screen flex flex-col">
    ...
    <main class="flex-grow container mx-auto px-4 py-8 flex items-center justify-center">
        <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 w-full max-w-md">
            <h2 class="text-2xl font-bold mb-6 text-center">パスワード再発行</h2>
            <form action="password_reset_process.php" method="post">
                <div class="mb-4">
                    ...
                    <input class="border border-blue-500 rounded-md px-3 py-2 text-gray-700 text-xl focus:outline-none focus:ring-2 focus:ring-blue-500 w-full" id="lid" type="text" name="lid" required placeholder="ID">
                </div>
                <div class="mb-6">
                ...
                <div class="flex items-center justify-between">
                    <input class="bg-blue-500 hover:bg-blue-700 text-white font-bold text-xl py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="submit" value="パスワード再発行">
                </div>
            </form>
